...
class LoginPage: Page {
    ...
    @discardableResult public func confirmAccountCreationIfVisible() -> Self {
        app.buttons[AccessibilityIdentifier.createAccountConfirmationButton]
            .tapWhenHittable(failOnUnmetCondition: false)
        return self
    }
